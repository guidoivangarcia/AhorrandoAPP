...
class ListaDeComprasKiosco extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <ScrollView
        ...
        <Block flex>
          ...
          <Block flex row>
            <Card item={articles[23]} style={{ marginRight: theme.SIZES.BASE }} >
            </Card>
            <Card item={articles[24]} />
            

          </Block>
          <Block flex row>
            <Card item={articles[25]} style={{ marginRight: theme.SIZES.BASE }} >
            </Card>
            <Card item={articles[26]} />
...
export default ListaDeComprasKiosco;
