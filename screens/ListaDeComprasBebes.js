...
class ListaDeComprasBebes extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <ScrollView
        ...
        <Block flex>
          ...
          <Block flex row>
            <Card item={articles[47]} style={{ marginRight: theme.SIZES.BASE }} >
            </Card>
            <Card item={articles[48]} />
          </Block>
          <Block flex row>
            <Card item={articles[49]} style={{ marginRight: theme.SIZES.BASE }} >
            </Card>
            <Card item={articles[50]} />
          </Block>
          <Block flex row style={{ paddingBottom: 310 }}>
            <Card item={articles[51]} style={{ marginRight: theme.SIZES.BASE }} />
            <Card item={articles[52]} />
          </Block>
...
export default ListaDeComprasBebes;
