        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>Pagina</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>No</Text>
                </Block>
                <Block row>
                  <Text color="white" size={60}>Encontrada</Text>
              ...
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                Ahorrando te permite ver y compartir información de productos y precios en cualquier punto de venta y compararlos en tiempo real.
              </Text>
